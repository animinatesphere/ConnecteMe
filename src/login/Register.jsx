  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0f172a]">
      <div className="flex flex-col items-center">
        ...
        {notification.show && (
          <div
            className={`fixed top-4 right-4 px-6 py-3 rounded-md shadow-md flex items-center space-x-2 transition-all duration-500 transform ${
        ...
        {/* Login Box */}
        <div className="w-[350px] lg:w-[700px] max-h-[700px] bg-[#121f3d] rounded-lg shadow-lg p-8">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                <div className="flex justify-between items-center">
                  <label
                    ...
                    className="block text-[16px] font-medium text-[#94A3B8]"
                  >
                    Name
                  </label>
                </div>
                <input
                  ...
                  className="mt-1 block w-[300px] px-3 py-2 bg-transparent border border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-[16px] text-[#94A3B8]"
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-[16px] font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 relative"
              >
                {loading ? (
                  <>
                    <span className="opacity-0">Account Signup</span>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#121f3d] text-gray-400">
                  OR USE WITH
                </span>
              </div>
            </div>
        ...
        <div className="mt-6 text-center text-sm mb-5">
          ...
          <Link
            to="/login"
            className="font-medium text-blue-500 hover:text-blue-400 text-[16px]"
          >
            Login
          </Link>
        </div>
